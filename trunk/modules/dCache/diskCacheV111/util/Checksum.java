...
public class Checksum {
   ...
   public Checksum( int type , byte [] digest ) {
      ...
      if( digest == null )
         throw new
         IllegalArgumentException( "digest == null") ;
   ...
   public Checksum( String digestString ) {
      ...
      if( digestString == null )
         throw new
         NullPointerException( "digestString == null") ;

      int del = digestString.indexOf(':');
      if( del < 1 )
          throw new
          IllegalArgumentException("Not a dCache checksum (no:)");
  ...
  */
   ...
   private void setValue(){ // ensure that _value is set only once as MessageDigest object resets after "digest" method call
     if( _value == null && _messageDigest != null )_value = _messageDigest.digest() ;
   }
