// $Id: DCapDoorInterpreterV5.java,v 1.3 2006-12-15 15:38:05 tigran Exp $
//
...
public class DCapDoorInterpreterV5 implements SessionRoot {
    ...
    private String   _revision       = "$Revision: 1.3 $" ; 
    private int      _uid            = -1 ;
    private int      _pid            = -1 ;
    ...
    public Object ac_session_$_1_99( Args args ) throws Exception {
      ...
      SessionHandler sh = 
              (SessionHandler)_sessions.get( Integer.valueOf(sessionId) ) ;
    ...
    public synchronized String com_open( int sessionId , int commandId , VspArgs args )
       ...
       try{   
            ...
            _sessions.put( Integer.valueOf(sessionId) , handler ) ;
            handler.go() ;
