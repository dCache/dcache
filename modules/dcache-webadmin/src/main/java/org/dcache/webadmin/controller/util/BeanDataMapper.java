...
import org.dcache.admin.webadmin.datacollector.datatypes.MoverInfo;
    ...
    public class BeanDataMapper {
        ...
        private static PoolQueueBean poolQueueModelToView(Pool poolBusinessObject) {
            ...
            returnPoolQueueBean.addRequestQueue(queuesModelToView("Restores", costInfo.getRestoreQueue(),
                            -1));
            returnPoolQueueBean.addRequestQueue(
                            queuesModelToView("Movers", costInfo.getMoverQueue()));
            returnPoolQueueBean.addRequestQueue(
                            queuesModelToView("P2P-Server", costInfo.getP2pQueue()));
