...
public class AclMapper {
    ...
    private static final Logger logger = LoggerFactory.getLogger(
          "logger.org.dcache.authorization." + AclMapper.class.getName());
    ...
    public static Permission[] getPermissions(Subject subject, Origin origin, Owner[] owners,
          ACL[] acls) {
        int len = acls.length;
    ...
    private static Permission getPermission(Subject subject, Origin origin, Owner owner, ACE ace,
          RsType rsType) throws ACLException {
        // if ( logger.isDebugEnabled() ) {
        // logger.debug("Subject: {}", subject);
        // logger.debug("Origin: {}", origin);
        // logger.debug("Owner: {}", owner);
