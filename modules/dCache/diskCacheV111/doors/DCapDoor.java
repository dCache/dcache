// $Id: DCapDoor.java,v 1.13.6.2 2007-03-10 01:00:05 podstvkv Exp $
...
//        _anyThread.start() ;
    ...
    public static CellVersion getStaticCellVersion(){ 
        return new CellVersion(diskCacheV111.util.Version.getVersion(),"$Revision: 1.13.6.2 $" ); 
    }
	...
	if( line.equals("") )return 0 ;
        ...
        try{
           ...
           p[0] = new Integer(sessionId) ;
           p[1] = new Integer(commandId) ;
           p[2] = args;
