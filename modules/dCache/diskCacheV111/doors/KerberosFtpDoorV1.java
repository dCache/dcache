// $Id: KerberosFtpDoorV1.java,v 1.10 2005-05-19 05:55:43 timur Exp $
...
public class KerberosFtpDoorV1 extends GssFtpDoorV1 {
    ...
    public KerberosFtpDoorV1(String name, StreamEngine engine, Args args) throws Exception{
        ...
        if( ( MyPrincipalStr = args.getOpt("svc-principal") ) == null ){
            String problem = "Kerberos FTP Door : -svc-principal not specified";
            esay( problem ) ;
            start();
            kill();
            throw new
        ...
        say(" initializing kerberos ftp door service principal is "+
        MyPrincipalStr);
        _GSSFlavor = "k5";
        str1 = MyPrincipalStr;
        say("str1 is "+str1);
    ...
    protected GSSContext getServiceContext() throws GSSException {
        ...
        say("calling _GManager.createName(\""+MyPrincipalStr+"\",null)");
        say("str1 is "+str1);
        GSSName MyPrincipal = _GManager.createName(MyPrincipalStr, null);
        say("MyPrincipal: " + MyPrincipal);
        ...
        try {
            ...
            0,"can not bind channel to localhost :"+e);
        }
