// $Id: NetHandler.java,v 1.1 2001-11-15 21:58:31 cvs Exp $
...
public class NetHandler {
   ...
   public void put(  Unit net , Object value ){
      ...
      _netList[bit].put( new Long( addr & _masks[bit] ) , value ) ;
   }
   public Object remove( Unit net ){
      ...
      Object value = _netList[bit].remove( new Long( addr ) ) ;
   ...
   public Object find( Unit net ){
      ...
      return _netList[bit].get( new Long( addr & _masks[bit]) ) ;
   }
