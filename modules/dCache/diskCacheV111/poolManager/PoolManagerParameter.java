...
public class  PoolManagerParameter implements java.io.Serializable {
    ...
    Map toMap(){
       ...
       map.put( "p2p-allowed"     , new Object[]{ new Boolean(_p2pAllowedSet)     , new Boolean(_p2pAllowed) } ) ;
       map.put( "p2p-oncost"      , new Object[]{ new Boolean(_p2pOnCostSet)      , new Boolean(_p2pOnCost) } ) ;
       map.put( "p2p-fortransfer" , new Object[]{ new Boolean(_p2pForTransferSet) , new Boolean(_p2pForTransfer) } ) ;
       map.put( "stage-allowed"   , new Object[]{ new Boolean(_hasHsmBackendSet)  , new Boolean(_hasHsmBackend) } ) ;
       map.put( "stage-oncost"    , new Object[]{ new Boolean(_stageOnCostSet)    , new Boolean(_stageOnCost) } ) ;
       
       map.put( "slope"    , new Object[]{ new Boolean(_slopeSet)           , new Double(_slope) } ) ;
       map.put( "idle"     , new Object[]{ new Boolean(_minCostCutSet)      , new Double(_minCostCut) } ) ;
       map.put( "p2p"      , new Object[]{ new Boolean(_costCutSet)         , new Double(_costCut) } ) ;
       map.put( "alert"    , new Object[]{ new Boolean(_alertCostCutSet)    , new Double(_alertCostCut) } ) ;
       map.put( "panic"    , new Object[]{ new Boolean(_panicCostCutSet)    , new Double(_panicCostCut) } ) ;
       map.put( "fallback" , new Object[]{ new Boolean(_fallbackCostCutSet) , new Double(_fallbackCostCut) } ) ;
       
       map.put( "spacecostfactor" , new Object[]{ new Boolean(_spaceCostFactorSet)       , new Double(_spaceCostFactor) } ) ;
       map.put( "cpucostfactor"   , new Object[]{ new Boolean(_performanceCostFactorSet) , new Double(_performanceCostFactor) } ) ;
       
       map.put( "max-pnfs-copies"    , new Object[]{ new Boolean(_maxPnfsFileCopiesSet) , new Integer(_maxPnfsFileCopies) } ) ;
       map.put( "same-host-copies"   , new Object[]{ new Boolean(_allowSameHostCopySet) , new Integer(_allowSameHostCopy) } ) ;
