 ...
 *
 * $Id: TransferManager.java,v 1.28.2.3 2007-01-04 03:03:00 timur Exp $
 * $Author: timur $
 */
...
//                 properties.setProperty("org.jpox.validateColumns","true");
//                 properties.setProperty("org.jpox.validateTables","true");
//                 properties.setProperty("org.jpox.validateConstraints","true");
    ...
    /**      */
    public  CellVersion getCellVersion(){ return new CellVersion(diskCacheV111.util.Version.getVersion(),"$Revision: 1.28.2.3 $" ); }
