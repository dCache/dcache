// $Id: CleanerV2.java,v 1.21 2006-02-02 09:15:40 patrick Exp $
//
...
public class CleanerV2 extends CellAdapter implements Runnable {
    ...
    private File   _dbDirectory   = null ;
    private File   _archive       = null ;
    private File   _currentDir    = null ;
    private File   _globalLock    = null ;
    private File   _currentRemoveList = null ;
	...
	pw.println("  Version           : $Id: CleanerV2.java,v 1.21 2006-02-02 09:15:40 patrick Exp $" ) ;
...
//	pw.println("  Exception         : " + _exceptionCounter);
    ...
    private void informBroadcaster(){
       ...
       String [] fileList = (String [] )list.toArray( new String[0] ) ;
    ...
    private void runDelete( String [] poolFileList ){
       ...
       for( int i = 0 ; ( i < poolFileList.length ) &&
                        ! Thread.currentThread().interrupted() ; i++ ){
    ...
    private String [] sendRemoveToPool( String poolName , List removeList ){

       PoolRemoveFilesMessage msg = new PoolRemoveFilesMessage(poolName);
       String [] pnfsList = (String[])removeList.toArray(new String[0]);
       if( _nullBug ){
    ...
    private int createSummary( PrintWriter pw  ){
       ...
       //
       try{ Thread.currentThread().sleep(2000L) ; }catch(Exception ee ){}
       //
       int validCounter = 0 ;
       int errorCounter = 0 ;
   ...
   private void getCacheInfoFromPnfsManager( PnfsId pnfsId , Set externalList ) throws Exception {
   ...
   private void getCacheInfoFromPnfsFilesystem(  File file , Set externalList ) throws Exception {
