// $Id: PnfsManager2.java,v 1.44 2005-11-22 10:59:29 patrick Exp $
...
public class PnfsManager2 extends CellAdapter {
    ...
    public CellVersion getCellVersion(){ return new CellVersion(diskCacheV111.util.Version.getVersion(),"$Revision: 1.44 $" ); }
    ...
    public void getInfo( PrintWriter pw ){
        ...
        while( mp.hasNext() ){
            PnfsFile.VirtualMountPoint vmp = (PnfsFile.VirtualMountPoint)mp.next() ;
            pw.println( " $Id: PnfsManager2.java,v 1.44 2005-11-22 10:59:29 patrick Exp $" ) ;
    ...
    private void getCacheLocations(PnfsGetCacheLocationsMessage pnfsMessage){
        try {
            ...
            while (e.hasMoreElements()){
                ...
                say("location of " + pf + " : " + location);
            }
            pnfsMessage.setCacheLocations(locations);
