// $Id: DCapProtocol_3_nio.java,v 1.9.4.5 2007-10-02 15:12:05 tigran Exp $
...
public class DCapProtocol_3_nio implements MoverProtocol, ChecksumMover {
   ...
   private  boolean   _calculateTransferCRC  = false ;
   ...
   public DCapProtocol_3_nio( CellAdapter cell ){
       ...
       //
       _cell.say( "DCapProtocol_3 (nio) created $Id: DCapProtocol_3_nio.java,v 1.9.4.5 2007-10-02 15:12:05 tigran Exp $" ) ;
       //
       ...
       _calculateTransferCRC = getParameterBoolean( "calculate-transfer-crc" , false ) ;
   }
   ...
   public void runIO(
        ...
        try{
          ...
          try{ socketChannel.close() ; }catch(Exception xe){}
...
//         _io_ok = false ;
   ...
   private void doTheWrite( FileChannel          fileChannel ,
        ...
        while( ! Thread.currentThread().isInterrupted()){
           ...
           int nextBlockSize = rest = _bigBuffer.getInt() ;
   ...
   private void updateChecksum( ByteBuffer buffer ){
      ...
      if( array == null ){
//         debug("Couldn't get array, creating a new one");
         buffer.rewind() ;
         array = new byte[buffer.limit()] ;
         buffer.get(array);
      }
      _transferMessageDigest.update(array);
   }
   private void doTheRead( FileChannel           fileChannel ,
        ...
        while( ! Thread.currentThread().isInterrupted()){
           ...
           int maxBuffer = _bigBuffer.capacity() - 4 ;
   ...
   public void  setDigest( Checksum checksum ){
      ...
      _transferMessageDigest = _calculateTransferCRC && ( checksum != null ) ? 
                               checksum.getMessageDigest() : null ;
   }
