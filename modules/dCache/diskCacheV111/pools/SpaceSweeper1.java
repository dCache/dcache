// $Id: SpaceSweeper1.java,v 1.5 2007-07-08 17:14:39 tigran Exp $
    ...
    implements SpaceSweeper, Runnable, CellCommandListener
{
    ...
    public void actionPerformed( CacheEvent event ){ /* forced by CacheRepositoryListener interface */}
    ...
    public void available( CacheRepositoryEvent event ){ /* forced by CacheRepositoryListener interface */}
    public void created( CacheRepositoryEvent event ){/* forced by CacheRepositoryListener interface */}
    public void destroyed( CacheRepositoryEvent event ){/* forced by CacheRepositoryListener interface */}
    ...
    public String ac_sweeper_ls( Args args )throws Exception {
       ...
       List<CacheRepositoryEntry> list = null ;
       synchronized( this ){
           list = new ArrayList<CacheRepositoryEntry>( _list ) ;
       }
       for( int i = 0 ; i < list.size() ; i++ ){
          CacheRepositoryEntry entry = list.get(i);
          if( l ){
    ...
    public void run(){
       ...
       List<CacheRepositoryEntry>  tmpList = new ArrayList<CacheRepositoryEntry>() ;
       ...
       while( ! Thread.interrupted() ){
           ...
           //
           Iterator<CacheRepositoryEntry> i = _list.iterator() ;
           try{
