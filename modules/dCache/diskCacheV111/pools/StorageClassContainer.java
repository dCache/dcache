// $Id: StorageClassContainer.java,v 1.15 2002-08-29 07:10:21 cvs Exp $ 
...
public class StorageClassContainer {
   ...
   private HashMap  _storageClasses = new HashMap() ;
   private HashMap  _pnfsIds        = new HashMap() ;
   private boolean  _poolStatusInfoChanged = true ;
   private StorageClassContainer _storageQueue = this ;
   private Object   _storageClassLock = new Object() ;
   
   public StorageClassContainer( String poolName ){
     _poolName = poolName ;
   }
   public synchronized Iterator getStorageClassInfos(){ 
      ArrayList list = new ArrayList(_storageClasses.values()) ;
   ...
   public int size(){ return _storageClasses.size() ; }
   public int getStorageClassCount(){ return _storageClasses.size() ; }
   public int getRequestCount(){ return _pnfsIds.size() ; }
   public StorageClassInfo 
        ...
        if( info == null )
           throw new
           NoSuchElementException( composedName ) ;
   ...
   public synchronized 
     StorageClassInfo removeStorageClass( String hsmName , String storageClass ){
        ...
        synchronized( _storageClassLock ){
           ...
           if( info.size() > 0 )
              throw new
              IllegalArgumentException( "Class not empty" ) ;
              
           return (StorageClassInfo)_storageClasses.remove( composedName ) ;
        }                   
   }
   public synchronized 
     void suspendStorageClass( 
           String hsmName , String storageClass , boolean suspend ){
	   ...
	   StorageClassInfo classInfo = 
           ...
           if( classInfo == null ){
              ...
              StorageClassInfo tmpInfo = 
                   (StorageClassInfo)_storageClasses.get("*@"+hsmName) ;
              if( tmpInfo != null ){
   ...
   public synchronized 
       ...
       if( info == null )return (new ArrayList()).iterator() ;
