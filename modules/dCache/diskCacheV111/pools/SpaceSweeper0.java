// $Id: SpaceSweeper0.java,v 1.26 2004-10-31 21:05:56 patrick Exp $
    ...
    implements SpaceSweeper, Runnable, CellCommandListener
{
    ...
    public void sticky( CacheRepositoryEvent event ){
       ...
       if( isSticky  ){
          ...
          if( ! isPrecious ){
             try{entry.touch() ;}catch(Exception ee){
    ...
    public String ac_sweeper_ls( Args args )throws Exception {
       ...
       for( int i = 0 ; i < _list.size() ; i++ ){
          CacheRepositoryEntry entry = (CacheRepositoryEntry)_list.get(i);
          if( l ){
