...
public class ThroughputFairShareSchedulingStrategyProvider implements SchedulingStrategyProvider
{
    ...
    {
        return new ThroughputFairShareSchedulingStrategy(discriminator);
    }
}
