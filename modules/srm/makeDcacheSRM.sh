...
export CLASSPATH=.
    ...
    CLASSPATH=$CLASSPATH:lib/globus/puretls.jar
    CLASSPATH=$CLASSPATH:lib/globus/cryptix.jar    
    CLASSPATH=$CLASSPATH:lib/globus/log4j-1.2.8.jar
    CLASSPATH=$CLASSPATH:lib/globus/cog-jglobus.jar  
    CLASSPATH=$CLASSPATH:lib/globus/cog-axis.jar  
    CLASSPATH=$CLASSPATH:lib/globus/cryptix-asn1.jar  
    CLASSPATH=$CLASSPATH:lib/globus/cryptix32.jar  
    CLASSPATH=$CLASSPATH:lib/globus/jce-jdk13-120.jar
