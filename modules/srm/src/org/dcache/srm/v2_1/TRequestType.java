...
public class TRequestType implements java.io.Serializable {
    ...
    public static final java.lang.String _PrepareToGet = "PrepareToGet";
    public static final java.lang.String _PrepareToPut = "PrepareToPut";
    public static final java.lang.String _Copy = "Copy";
    public static final TRequestType PrepareToGet = new TRequestType(_PrepareToGet);
    public static final TRequestType PrepareToPut = new TRequestType(_PrepareToPut);
