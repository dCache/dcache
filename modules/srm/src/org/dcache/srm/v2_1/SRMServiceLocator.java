...
public class SRMServiceLocator extends org.apache.axis.client.Service implements org.dcache.srm.v2_1.SRMService {
     ...
     */
    private java.lang.String srm_address = "https://localhost:8443/srm/managerv2";
    ...
    public org.dcache.srm.v2_1.ISRM getsrm() throws javax.xml.rpc.ServiceException {
    ...
    public org.dcache.srm.v2_1.ISRM getsrm(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.dcache.srm.v2_1.SrmSoapBindingStub _stub = new org.dcache.srm.v2_1.SrmSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.dcache.srm.v2_1.ISRM.class.isAssignableFrom(serviceEndpointInterface)) {
                org.dcache.srm.v2_1.SrmSoapBindingStub _stub = new org.dcache.srm.v2_1.SrmSoapBindingStub(new java.net.URL(srm_address), this);
                _stub.setPortName(getsrmWSDDServiceName());
                return _stub;
            }
        }
