/** $Id: Storage.java,v 1.22 2006-06-23 21:12:18 timur Exp $
 */
...
/** @todo protocols init - this is placehoder*/
  ...
  public String[] supportedGetProtocols()
    ...
    dlog("supportedGetProtocols: " + getProtocols.toString() );
  ...
  public String[] supportedPutProtocols()
    ...
    dlog("supportedPutProtocols: " + putProtocols.toString() );
...
//    throw srmEx;
      ...
      throws SRMException
  {
    ...
    try {
      dlog("Execute command in the main thread: " +cmd );
      proc = Runtime.getRuntime().exec(cmd);
      proc.waitFor();
    }
    catch (IOException ex) {
      elog("IOException in localCopy(): " + cmd.toString() );
      elog(ex);
      throw new SRMException( ex );
    }
    catch (InterruptedException ex) {
      elog("InterruptedException in localCopy(): " + cmd.toString() );
      elog(ex);
      throw new SRMException( ex );
    }
