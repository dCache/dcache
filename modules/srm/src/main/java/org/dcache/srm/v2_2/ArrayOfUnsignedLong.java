...
public class ArrayOfUnsignedLong  implements java.io.Serializable {
    private static final long serialVersionUID = 4067996539981737582L;
    ...
    public ArrayOfUnsignedLong(
           org.apache.axis.types.UnsignedLong[] unsignedLongArray) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        boolean _equals;
        _equals = true && 
            ((this.unsignedLongArray==null && other.getUnsignedLongArray()==null) || 
             (this.unsignedLongArray!=null &&
              java.util.Arrays.equals(this.unsignedLongArray, other.getUnsignedLongArray())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getUnsignedLongArray() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getUnsignedLongArray());
                 i++) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://srm.lbl.gov/StorageResourceManager", "ArrayOfUnsignedLong"));
