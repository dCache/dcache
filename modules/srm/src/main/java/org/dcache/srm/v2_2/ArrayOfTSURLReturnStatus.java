...
public class ArrayOfTSURLReturnStatus  implements java.io.Serializable {
    ...
    public ArrayOfTSURLReturnStatus(
           org.dcache.srm.v2_2.TSURLReturnStatus[] statusArray) {
     ...
     * @return statusArray
     */
    public org.dcache.srm.v2_2.TSURLReturnStatus[] getStatusArray() {
        return statusArray;
    }
     ...
     * @param statusArray
     */
    public void setStatusArray(org.dcache.srm.v2_2.TSURLReturnStatus[] statusArray) {
        this.statusArray = statusArray;
    }

    public org.dcache.srm.v2_2.TSURLReturnStatus getStatusArray(int i) {
        return this.statusArray[i];
    }

    public void setStatusArray(int i, org.dcache.srm.v2_2.TSURLReturnStatus _value) {
