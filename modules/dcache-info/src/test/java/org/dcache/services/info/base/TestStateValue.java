...
/**
 * This is a minimal non-abstract implementation of StateComponent that extends StateValue. Calls to
 * acceptVisitor() are recorded and can be listed later. Several inherited abstract methods are
 * implemented with a boobytrap: any attempt to use method the abstract methods will result in the
 * JUnit test failing.
 *
...
public class TestStateValue extends StateValue {
    ...
    /**
     * Acquire information about the acceptVisitor() calls.  The provided List is the calls in the
