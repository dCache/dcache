...
public class StateUpdateTests {
    ...
    @Before
    public void setUp() {
        _update.appendUpdate(NEW_STRING_PATH,
              new StringStateValue(NEW_STRING_VALUE, MORTAL_METRIC_DURATION));
    ...
    public void testAppendUpdate() {
        _update.appendUpdate(NEW_INTEGER_PATH.parentPath().newChild("anotherInteger"),
              new IntegerStateValue(39, MORTAL_METRIC_DURATION));
    ...
    public void testUpdateTransition() throws BadStatePathException {
        ...
        assertTrue("missing branch metric",
              newBranchScs.childIsNew(NEW_INTEGER_PATH.getLastElement()));
    }
    ...
    public void testAddBadPath() throws BadStatePathException {
        ...
        _update.appendUpdate(NEW_STRING_PATH.newChild("anotherMetric"),
              new StringStateValue("foo", MORTAL_METRIC_DURATION));
    ...
    public void testHasUpdateNull() {
        ...
        assertFalse("check hasUpdate with null StateValue",
              _update.hasUpdate(NEW_STRING_PATH, null));
    }
    ...
    public void testHasUpdateSubPath() {
        ...
        assertFalse("check component with sub path",
              _update.hasUpdate(NEW_STRING_PATH.newChild("sub-element"), newComponent));
    }
    ...
    public void testHasUpdateSuperPath() {
        ...
        assertFalse("check component with super path",
              _update.hasUpdate(NEW_STRING_PATH, newComponent));
    }
    ...
    public void testHasUpdateDifferentPath() {
        ...
        assertFalse("check component with different path",
              _update.hasUpdate(StatePath.parsePath("element1.element2"), newComponent));
    }
    ...
    public void testHasUpdateComposite() {
        ...
        assertTrue("check composite with same path",
              _update.hasUpdate(newComponentPath, newComponent));
    }
