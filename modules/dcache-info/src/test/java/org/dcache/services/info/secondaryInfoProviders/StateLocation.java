...
/**
 * The StateLocation class contains a collection of static methods and fields that describe how
 * dCache uses state.
 * <p>
 * The class includes support for updating TestStateExhibitor (i.e., adding metrics to a fake dCache
 * state) and for updating MalleableStateTransition (i.e., faking addition, updating or removal of
 * metrics).
 */
