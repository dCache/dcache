...
/**
 * Some tests that check the MessageHandlerChain's implementation of the MessageSender Interface
 */
public class MessageHandlerChainAsMessageSenderTests {

    /**
     * A simple test CellMessageAnswerable that fails if any of the methods are called.
     */
    ...
    /**
     * A simple test-class that allows us to enquire what outgoing messages are being sent. Calls to
     * methods other than sendMessage() will fail the test.
     */
