...
/**
 * Some tests that check the MessageHandlerChain's implementation of the MessageMetadataRepository
 * Interface
 */
public class MessageHandlerChainAsMessageMetadataRepositoryTests {
    ...
    public void testContainsPresentMessageTTL() {
        assertTrue("checking containsMetricTTL for available message ID",
              _metadataRepo.containsMetricTTL(AVAILABLE_ID));
    }

    @Test
    public void testContainsNonPresentMessageTTL() {
        assertFalse("checking containsMetricTTL for absent message ID",
    ...
    public void testRemoveAvailableMessage() {
        ...
        assertFalse("Checking availablity after remove",
              _metadataRepo.containsMetricTTL(AVAILABLE_ID));
    }
