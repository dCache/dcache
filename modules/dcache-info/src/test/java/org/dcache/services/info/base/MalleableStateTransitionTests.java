...
/**
 * A set of tests to verify that MalleableStateTransition behaves as expected.
 * <p>
...
public class MalleableStateTransitionTests {
    ...
    /**
     * A handy wrapper to check that the {@link VerifyingVisitor} is satisfied with the {@link
     * TestStateExhibitor} when visiting with the current MalleableStateTransition.
     */
