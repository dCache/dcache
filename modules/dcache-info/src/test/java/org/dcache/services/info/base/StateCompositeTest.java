...
public class StateCompositeTest extends InfoBaseTestHelper {
    ...
    public void setUp() {
        ...
        transition.getOrCreateChangeSet(null)
              .recordNewChild(BRANCH_EPHEMERAL_NAME, _ephemeralComposite);
        transition.getOrCreateChangeSet(null).recordNewChild(BRANCH_MORTAL_NAME, _mortalComposite);
        transition.getOrCreateChangeSet(null)
              .recordNewChild(BRANCH_IMMORTAL_NAME, _immortalComposite);
    ...
    public void testStateCompositeLong() {
        assertNotNull("Cannot create mortal StateComposite with +ve life-time",
              new StateComposite(60));
        assertNotNull("Cannot create mortal StateComposite with 0s life-time.",
              new StateComposite(0));
        assertNotNull("Cannot create mortal StateComposite with -ve life-time.",
              new StateComposite(-5));
    }
    ...
    public void testStateCompositeStatePersistentMetadata() {
        ...
        assertNotNull("Cannot create immortal StateComposite",
              new StateComposite(new StatePersistentMetadata()));
    }
    ...
    public void testGetEarliestChildExpiryDate() throws MetricStatePathException {
        assertNotNull(
              "immortal StateComposite with mortal children returned null for getEarliestChildExpiryDate()",
              _rootComposite.getEarliestChildExpiryDate());
        assertNull(
              "immortal StateComposite with no children returned non-null for getEarliestChildExpiryDate()",
              _immortalComposite.getEarliestChildExpiryDate());
        assertNull(
              "ephemeral StateComposite with no children returned non-null for getEarliestChildExpiryDate()",
              _ephemeralComposite.getEarliestChildExpiryDate());
        assertNull("mortal StateComposite returned null for getEarliestChildExpiryDate()",
              _mortalComposite.getEarliestChildExpiryDate());
        ...
        addMetric(BRANCH_IMMORTAL_PATH.newChild("ephemeralString"),
              new StringStateValue("ephemeralStringValue"));
        addMetric(BRANCH_MORTAL_PATH.newChild("ephemeralString"),
              new StringStateValue("ephemeralStringValue"));
        addMetric(BRANCH_EPHEMERAL_PATH.newChild("ephemeralString"),
              new StringStateValue("ephemeralStringValue"));
        assertNull("immortal StateComposite returned non-NULL for getEarliestChildExpiryDate()",
              _immortalComposite.getEarliestChildExpiryDate());
        assertNull("mortal StateComposite returned non-NULL for getEarliestChildExpiryDate()",
              _mortalComposite.getEarliestChildExpiryDate());
        assertNull("immortal StateComposite returned non-NULL for getEarliestChildExpiryDate()",
              _ephemeralComposite.getEarliestChildExpiryDate());
        ...
        addMetric(BRANCH_IMMORTAL_PATH.newChild("mediumDurationMortalString"),
              new StringStateValue("dummy value", mediumMetricDuration));
        addMetric(BRANCH_MORTAL_PATH.newChild("mediumDurationMortalString"),
              new StringStateValue("dummy value", mediumMetricDuration));
        addMetric(BRANCH_EPHEMERAL_PATH.newChild("mediumDurationMortalString"),
              new StringStateValue("dummy value", mediumMetricDuration));
        assertDatedDuration("getEarliestChildExp() returned wrong Date", now,
              _mortalComposite.getEarliestChildExpiryDate(), mediumMetricDuration, tolerance);
        assertDatedDuration("getEarliestChildExp() returned wrong Date", now,
              _immortalComposite.getEarliestChildExpiryDate(), mediumMetricDuration, tolerance);
        assertDatedDuration("getEarliestChildExp() returned wrong Date", now,
              _ephemeralComposite.getEarliestChildExpiryDate(), mediumMetricDuration, tolerance);

        // Add a longer-lived mortal child
        addMetric(BRANCH_IMMORTAL_PATH.newChild("longDurationMortalString"),
              new StringStateValue("dummy value", longMetricDuration));
        addMetric(BRANCH_MORTAL_PATH.newChild("longDurationMortalString"),
              new StringStateValue("dummy value", longMetricDuration));
        addMetric(BRANCH_EPHEMERAL_PATH.newChild("longDurationMortalString"),
              new StringStateValue("dummy value", longMetricDuration));
        assertDatedDuration("getEarliestChildExp() returned wrong Date", now,
              _immortalComposite.getEarliestChildExpiryDate(), mediumMetricDuration, tolerance);
        assertDatedDuration("getEarliestChildExp() returned wrong Date", now,
        ...
        addMetric(BRANCH_IMMORTAL_PATH.newChild("shortDurationMortalString"),
              new StringStateValue("dummy value", shortMetricDuration));
        addMetric(BRANCH_MORTAL_PATH.newChild("shortDurationMortalString"),
              new StringStateValue("dummy value", shortMetricDuration));
        addMetric(BRANCH_EPHEMERAL_PATH.newChild("shortDurationMortalString"),
              new StringStateValue("dummy value", shortMetricDuration));
        assertDatedDuration("getEarliestChildExp() returned wrong Date", now,
              _immortalComposite.getEarliestChildExpiryDate(), shortMetricDuration, tolerance);
        assertDatedDuration("getEarliestChildExp() returned wrong Date", now,
              _mortalComposite.getEarliestChildExpiryDate(), shortMetricDuration, tolerance);
        assertDatedDuration("getEarliestChildExp() returned wrong Date", now,
              _ephemeralComposite.getEarliestChildExpiryDate(), shortMetricDuration, tolerance);

        // Override the short-lived mortal child with a new one that will last a bit longer.
        addMetric(BRANCH_IMMORTAL_PATH.newChild("shortDurationMortalString"),
              new StringStateValue("dummy value", shortishMetricDuration));
        addMetric(BRANCH_MORTAL_PATH.newChild("shortDurationMortalString"),
              new StringStateValue("dummy value", shortishMetricDuration));
        addMetric(BRANCH_EPHEMERAL_PATH.newChild("shortDurationMortalString"),
              new StringStateValue("dummy value", shortishMetricDuration));
        assertDatedDuration("getEarliestChildExp() returned wrong Date", now,
              _immortalComposite.getEarliestChildExpiryDate(), shortishMetricDuration, tolerance);
        assertDatedDuration("getEarliestChildExp() returned wrong Date", now,
              _mortalComposite.getEarliestChildExpiryDate(), shortishMetricDuration, tolerance);
        assertDatedDuration("getEarliestChildExp() returned wrong Date", now,
              _ephemeralComposite.getEarliestChildExpiryDate(), shortishMetricDuration, tolerance);
    }
    ...
    public void testToString() throws MetricStatePathException {
        assertEquals("Immortal with three children.", "StateComposite <#> {3}",
              _rootComposite.toString());
        assertEquals("Immortal with no children.", "StateComposite <#> {0}",
              _immortalComposite.toString());
        assertEquals("Mortal with no children.", "StateComposite <+> {0}",
              _mortalComposite.toString());
        assertEquals("Ephemeral with no children.", "StateComposite <*> {0}",
              _ephemeralComposite.toString());
        ...
        assertEquals("Immortal with one child.", "StateComposite <#> {1}",
              _immortalComposite.toString());
        assertEquals("Mortal with one child.", "StateComposite <+> {1}",
              _mortalComposite.toString());
        assertEquals("Ephemeral with one child.", "StateComposite <*> {1}",
              _ephemeralComposite.toString());
    }
    ...
    public void testGetExpiryDate() {
        ...
        assertDatedDuration("mortal StateComposite has wrong expiry date.", new Date(),
              sc.getExpiryDate(), expiryTime, 1);

        sc = new StateComposite(0);
        assertDatedDuration("mortal StateComposite has wrong expiry date.", new Date(),
              sc.getExpiryDate(), 0, 1);
    ...
    public void testAcceptVisitorVarious() {
        ...
        assertVisitorAddMetric(visitor,
              BRANCH_EPHEMERAL_PATH.newChild("float-metric"),
              new FloatingPointStateValue(3.14159265));
        assertVisitorAddMetric(visitor,
        ...
        assertVisitorAddMetric(visitor,
              BRANCH_EPHEMERAL_PATH.newChild("float-metric"),
              new FloatingPointStateValue(1.41421356));
        assertVisitorAddMetric(visitor,
              BRANCH_EPHEMERAL_PATH.newChild("bool-metric"), new BooleanStateValue(false));

        /* Create metrics on fresh branches */
        assertVisitorAddMetric(visitor,
              BRANCH_EPHEMERAL_PATH.newChild("string-metric-branch").newChild("string-metric"),
              new StringStateValue("baz"));
        assertVisitorAddMetric(visitor,
              BRANCH_MORTAL_PATH.newChild("int-metric-branch").newChild("int-metric"),
              new IntegerStateValue(42));
        assertVisitorAddMetric(visitor,
              BRANCH_MORTAL_PATH.newChild("float-metric-branch").newChild("float-metric"),
              new FloatingPointStateValue(3.14159));
        assertVisitorAddMetric(visitor,
              BRANCH_MORTAL_PATH.newChild("bool-metric-branch").newChild("bool-metric"),
    ...
    public void testAcceptVisitorStateTransitionStatePathStatePathStateVisitor() {
        ...
        assertVisitTransition(BRANCH_EPHEMERAL_PATH.newChild("new-branch").newChild("MyMetric"),
              metric);
        assertVisitTransition(BRANCH_MORTAL_PATH.newChild("new-branch").newChild("MyMetric"),
              metric);
        assertVisitTransition(BRANCH_IMMORTAL_PATH.newChild("new-branch").newChild("MyMetric"),
              metric);
    ...
    public void testUpdateCompositeWithChildren() throws MetricStatePathException {
        ...
        StateTransition transition = new StateTransition();
        _rootComposite.buildTransition(null, BRANCH_MORTAL_PATH,
              new StateComposite(LIFETIME_MORTAL_COMPOSITE + 10), transition);

        visitor.assertSatisfiedTransition("Not satisfied whilst updating", _rootComposite,
              transition);
    ...
    public void testApplyTransitionRemovingMetrics() throws MetricStatePathException {
        ...
        assertTrue("mortal branch change-set doesn't contain expected metric",
              mortalBranchScs._removedChildren.contains(metricName));
        ...
        visitorNoMetric.assertSatisfied("checking no-metric after removing expired metric",
              _rootComposite);
    }
    ...
    public void testApplyTransitionUpdatingStringMetrics() throws MetricStatePathException {
        ...
        assertNotNull("mortal branch change-set is null", mortalBranchScs);
        assertTrue("mortal branch change-set doesn't contain expected metric",
              mortalBranchScs._updatedChildren.containsKey(metricName));
    ...
    public void testBuildTransitionNewMetricForRoot() throws MetricStatePathException {
        ...
        _rootComposite.buildTransition(null, new StatePath(newMetricName), newMetricValue,
              transition);
        ...
        assertSame("new metric is not as expected", scs.getNewChildValue(newMetricName),
              newMetricValue);
    }
    ...
    public void testBuildTransitionUpdatedMetricForRoot() throws MetricStatePathException {
        ...
        assertSame("new metric is not as expected", scs.getUpdatedChildValue(metricName),
              newMetricValue);
    }
    ...
    public void testBuildTransitionNewMetricForExistingBranch() throws MetricStatePathException {
        ...
        _rootComposite.buildTransition(null, BRANCH_EPHEMERAL_PATH.newChild(newMetricName),
              newMetricValue, transition);
        ...
        assertTrue("itr into ephemeral branch not found",
              rootScs.getItrChildren().contains(BRANCH_EPHEMERAL_NAME));
        ...
        assertSame("new metric is not as expected", ephemeralScs.getNewChildValue(newMetricName),
              newMetricValue);
    }
    ...
    public void testBuildTransitionNewMetricForNewBranch() throws MetricStatePathException {
        ...
        _rootComposite.buildTransition(null, newBranchPath.newChild(newMetricName), newMetricValue,
              transition);
        ...
        assertTrue("itr into newBranch branch not found",
              ephemeralScs.getItrChildren().contains(newBranchName));
        ...
        assertSame("new metric is not as expected", newBranchScs.getNewChildValue(newMetricName),
              newMetricValue);
    }
    ...
    public void testIsEphemeral() {
        ...
        assertFalse("Mortal StateComposite returns wrong isEphemeral",
              mortalStateComposite.isEphemeral());

        StateComposite immortalStateComposite = new StateComposite(null);

        assertFalse("Immortal StateComposite returns wrong isEphemeral",
              immortalStateComposite.isEphemeral());

        StateComposite ephemeralStateComposite = new StateComposite();

        assertTrue("Ephemeral StateComposite returns wrong isEphemeral",
              ephemeralStateComposite.isEphemeral());
    }
    ...
    public void testIsImmortal() {
        StateComposite mortalStateComposite = new StateComposite(1000);
        assertFalse("Mortal StateComposite returns wrong isImmortal",
              mortalStateComposite.isImmortal());

        StateComposite immortalStateComposite = new StateComposite(null);

        assertTrue("Immortal StateComposite returns wrong isImmortal",
              immortalStateComposite.isImmortal());

        StateComposite ephemeralStateComposite = new StateComposite();

        assertFalse("Ephemeral StateComposite returns wrong isImmortal",
              ephemeralStateComposite.isImmortal());
    }
    ...
    public void testIsMortal() {
        ...
        assertFalse("Immortal StateComposite returns wrong isMoral",
              immortalStateComposite.isMortal());

        StateComposite ephemeralStateComposite = new StateComposite();

        assertFalse("Ephemeral StateComposite returns wrong isMortal",
              ephemeralStateComposite.isMortal());
    }
     ...
     */
    @Test
    public void testBuildRemovalTransitionNotForcedWithMetricInRoot()
          throws MetricStatePathException {
     ...
     */
    @Test
    public void testBuildRemovalTransitionNotForcedWithMetricInBranch()
          throws MetricStatePathException {
        ...
        _rootComposite.buildTransition(null, BRANCH_MORTAL_PATH.newChild(expMetricName),
              new StringStateValue("dummy metric value", 0), t);
    ...
    public void testBuildRemovalTransitionNoExpMortalsIsForced() throws MetricStatePathException {
        ...
        assertTrue("missing ephemeral branch from itr",
              scs.getItrChildren().contains(BRANCH_EPHEMERAL_NAME));
        assertTrue("missing immortal branch from itr",
              scs.getItrChildren().contains(BRANCH_IMMORTAL_NAME));
        assertTrue("missing mortal branch from itr",
              scs.getItrChildren().contains(BRANCH_MORTAL_NAME));
        assertTrue("missing metric from itr", scs.getItrChildren().contains(metricName));

        assertTrue("missing ephemeral branch from remove",
              scs.getRemovedChildren().contains(BRANCH_EPHEMERAL_NAME));
        assertTrue("missing immortal branch from remove",
              scs.getRemovedChildren().contains(BRANCH_IMMORTAL_NAME));
        assertTrue("missing mortal branch from remove",
              scs.getRemovedChildren().contains(BRANCH_MORTAL_NAME));
    ...
    public void testEqualsObject() {
        ...
        assertTrue("_mortalComposite not equal to itself",
              _mortalComposite.equals(_mortalComposite));
        assertTrue("_immortalComposite not equal to itself",
              _immortalComposite.equals(_immortalComposite));
        assertTrue("_ephemeralComposite not equal to itself",
              _ephemeralComposite.equals(_ephemeralComposite));
    }
    ...
    public void testRootEphemeralNotEqual() {
        assertFalse("_rootComposite equal to _ephemeralComposite",
              _rootComposite.equals(_ephemeralComposite));
    }

    @Test
    public void testRootMortalNotEqual() {
        assertFalse("_rootComposite equal to _mortalComposite",
              _rootComposite.equals(_mortalComposite));
    }

    @Test
    public void testRootImmortalNotEqual() {
        // Different since _rootComposite has children whilst _immortalComposite doesn't.
        assertFalse("_rootComposite equal to _immortalComposite",
              _rootComposite.equals(_immortalComposite));
    }

    @Test
    public void testImmortalRootNotEqual() {
        assertFalse("_immortalComposite equal to _rootComposite",
              _immortalComposite.equals(_rootComposite));
    }

    @Test
    public void testEphemeralMortalEqual() {
        assertEquals("_ephemeralComposite equal to _mortalComposite", _ephemeralComposite,
              _mortalComposite);
    }

    @Test
    public void testEphemeralImmortalEqual() {
        assertEquals("_ephemeralComposite equal to _immortalComposite", _ephemeralComposite,
              _immortalComposite);
    }

    @Test
    public void testEphemeralRootNotEqual() {
        assertFalse("_ephemeralComposite equal to _rootComposite",
              _ephemeralComposite.equals(_rootComposite));
    }

    @Test
    public void testMortalRootNotEqual() {
        assertFalse("_mortalComposite equal to _rootComposite",
              _mortalComposite.equals(_rootComposite));
    }

    @Test
    public void testMortalImmortalEqual() {
        assertEquals("_mortalComposite equal to _immortalComposite", _mortalComposite,
              _immortalComposite);
    }

    @Test
    public void testMortalEphemeralEqual() {
        assertEquals("_mortalComposite equal to _ephemeralComposite", _mortalComposite,
              _ephemeralComposite);
    }

    @Test
    public void testImmortalMortalEqual() {
        assertEquals("_immortalComposite equal to _mortalComposite", _immortalComposite,
              _mortalComposite);
    }

    @Test
    public void testImmortalEphemeralEqual() {
        assertEquals("_immortalComposite equal to _ephemeralComposite", _immortalComposite,
              _ephemeralComposite);
    }
    ...
    public void testNewMortalComposite() throws InterruptedException, MetricStatePathException {
        ...
        assertEquals("Mortal Composite equal to Mortal with different expiry date",
              _mortalComposite, myMortalComposite);
        assertEquals("Mortal Composite equal to Mortal with different expiry date",
              myMortalComposite, _mortalComposite);

        // Quickly add a child metric to myMortalComposite.
        StateTransition t = new StateTransition();
        myMortalComposite.buildTransition(null, new StatePath("test-child"),
              new StringStateValue("foo", 10), t);
        myMortalComposite.applyTransition(null, t);

        assertFalse("Empty mortal equal to one with a child",
              myMortalComposite.equals(_mortalComposite));
    }
    ...
    public void testNewImmortalComposite() throws MetricStatePathException {
        ...
        assertEquals("Immortal Composite not equal to Immortal", _immortalComposite,
              myImmortalComposite);
        assertEquals("Immortal Composite not equal to Immortal", myImmortalComposite,
              _immortalComposite);

        assertEquals("_ephemeralComposite not equal to Immortal", _ephemeralComposite,
              myImmortalComposite);
        assertEquals("Immortal not equal to _ephemeralComposite", myImmortalComposite,
              _ephemeralComposite);

        assertEquals("_mortalComposite not equal to Immortal", _mortalComposite,
              myImmortalComposite);
        assertEquals("Immortal not equal to _mortalComposite", myImmortalComposite,
              _mortalComposite);

        addMetricToComposite(myImmortalComposite, "test-child", new StringStateValue("foo", 10));

        assertFalse("Empty immortal equal to one with a child",
              myImmortalComposite.equals(_immortalComposite));
    }
    ...
    public void testNewEphemeralComposite() throws MetricStatePathException {
        ...
        assertEquals("Ephemeral Composite not equal to Ephemeral", _ephemeralComposite,
              myEphemeralComposite);
        assertEquals("Ephemeral Composite not equal to Ephemeral", myEphemeralComposite,
              _ephemeralComposite);

        assertEquals("_immortalComposite equal to Ephemeral", _immortalComposite,
              myEphemeralComposite);
        ...
        assertFalse("Empty ephemeral equal to one with a child",
              myEphemeralComposite.equals(_ephemeralComposite));
    }

    @Test
    public void testHashCodeSame() {
        assertEquals("_rootComposite hashCode different", _rootComposite.hashCode(),
              _rootComposite.hashCode());
        assertEquals("_mortalComposite hashCode different", _mortalComposite.hashCode(),
              _mortalComposite.hashCode());
        assertEquals("_immortalComposite hashCode different", _immortalComposite.hashCode(),
              _immortalComposite.hashCode());
        assertEquals("_ephemeralComposite hashCode different", _ephemeralComposite.hashCode(),
              _ephemeralComposite.hashCode());
    }

    @Test
    public void testHashCodeNotSameRootMortal() {
        assertNotSame("_rootComposite hashCode same as _mortal hashCode", _rootComposite.hashCode(),
              _mortalComposite.hashCode());
    }
    ...
    public void testImmortalChildMakingMortalCompositeImmortal() throws MetricStatePathException {
        ...
        addMetric(BRANCH_MORTAL_PATH.newChild("immortal metric"),
              new StringStateValue("dummy metric value", true));
        assertIsImmortal("mortal composite not promoted to immortality", _mortalComposite);
    }

    @Test
    public void testImmortalChildMakingEphemeralCompositeImmortal()
          throws MetricStatePathException {
        addMetric(BRANCH_EPHEMERAL_PATH.newChild("immortal metric"),
              new StringStateValue("dummy metric value", true));
    ...
    public void testPurgeEverythingScs() {
        ...
        assertTrue("Ephemeral branch is to be removed",
              rootScs.childIsRemoved(BRANCH_EPHEMERAL_NAME));
        assertTrue("Mortal branch is to be removed", rootScs.childIsRemoved(BRANCH_MORTAL_NAME));
        assertTrue("Immortal branch is to be removed",
              rootScs.childIsRemoved(BRANCH_IMMORTAL_NAME));
    ...
    public void testPurgeEverythingVisit() {
        ...
        VerifyingVisitor emptyVisitor = new VerifyingVisitor();
        emptyVisitor.assertSatisfiedTransition("checking state is complete empty", _rootComposite,
              transition);
    }
    ...
    public void testPurgeMortalScs() {
        ...
        assertFalse("Ephemeral branch is to be removed",
              rootScs.childIsRemoved(BRANCH_EPHEMERAL_NAME));
        assertTrue("Mortal branch is to be removed", rootScs.childIsRemoved(BRANCH_MORTAL_NAME));
        assertFalse("Immortal branch is to be removed",
              rootScs.childIsRemoved(BRANCH_IMMORTAL_NAME));
    ...
    public void testPurgeMortalVisit() {
        ...
        visitor.assertSatisfiedTransition("checking state contains two branches", _rootComposite,
              transition);
    }
    ...
    public void testPurgeMortalBranchWithMetricScs() throws MetricStatePathException {
        ...
        addMetric(BRANCH_MORTAL_PATH.newChild(metricName),
              new StringStateValue("String value", 100));
    ...
    public void testPurgeMortalMetricThenAddMetricScs() throws MetricStatePathException {
        ...
        assertNull("Check that immortal Scs doesn't exists",
              transition.getStateChangeSet(BRANCH_IMMORTAL_PATH));

        assertNull("Check that ephemeral Scs doesn't exists",
              transition.getStateChangeSet(BRANCH_EPHEMERAL_PATH));
        ...
        assertFalse("check metric is not to be removed",
              mortalBranchScs.childIsRemoved(metricName));
    }
    ...
    @Test
    public void testPurgeMortalBranchWithTwoMetricsThenAddMetricScs()
          throws MetricStatePathException {
        ...
        assertFalse("check metric is not to be removed",
              mortalBranchScs.childIsRemoved(metricName));
        assertTrue("check doomedMetric is still to be removed",
              mortalBranchScs.childIsRemoved(doomedMetricName));
    }


    @Test
    public void testPurgeMortalBranchWithTwoMetricsThenAddMetricThenApply()
          throws MetricStatePathException {
    ...
    @Test
    public void testPurgeMortalBranchWithTwoMetricsThenAddMetricVisit()
          throws MetricStatePathException {
     ...
     */
    private void addMetric(StatePath metricPath, StateValue metricValue)
          throws MetricStatePathException {
        StateTransition transition = new StateTransition();
        _rootComposite.buildTransition(null, metricPath, metricValue, transition);
        _rootComposite.applyTransition(null, transition);
     ...
     */
    private void addMetricToComposite(StateComposite c, String metricName, StateValue metricValue)
          throws MetricStatePathException {
