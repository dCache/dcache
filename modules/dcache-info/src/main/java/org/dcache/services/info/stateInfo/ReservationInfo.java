...
/**
 * Objects of this Class contain information about an SRM reservation as obtained from dCache
 * state.
 */
public class ReservationInfo {
    ...
    public enum AccessLatency {
        ...
        /**
         * Look up the AccessLatency value that matches the given metric value.
         *
         * @param metricValue
    ...
    public enum RetentionPolicy {
        ...
        /**
         * Look up the RetentionPolicy value that matches the given metric value.
         *
         * @param metricValue
