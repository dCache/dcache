...
/**
 * This class sends a series of messages based on the current state tree. It uses a visitor to
 * extract all entries below a certain point in the state tree and constructs a message for each
 * entry; for example, if the path is "dCache.pools" and the state contains entries for
