...
/**
 * An exception thrown when a StatePath refers to an element that should be a StateComponsite (i.e.,
 * a branch), but is a StateValue (a leaf).
 *
...
public class MetricStatePathException extends BadStatePathException {
    ...
    /**
     * Create a new MetricStatePathException when the child (childName) is a metric-node instead of
     * a branch-node.
     *
