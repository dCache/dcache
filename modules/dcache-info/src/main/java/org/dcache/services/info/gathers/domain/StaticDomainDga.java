...
/**
 * Activity to periodically query the System cell in each known domain by issuing the ASCII command
 * "show context info.static".  The returned message containing the result is parsed by the
 * CellMessageAnswerable supplied.
 */
