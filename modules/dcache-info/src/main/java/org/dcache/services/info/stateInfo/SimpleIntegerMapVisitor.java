...
/**
 * Build a Map<String,Long> that maps between a particular entry in a list of items and some
 * IntegerStateValue a fixed relative path from each list item.  For example, if the state tree
...
public class SimpleIntegerMapVisitor extends SimpleSkeletonMapVisitor {
    ...
    /**
     * Build a mapping between list items and some StringStateValue value for dCache's current
     * state.
     *
     ...
     */
    public static final Map<String, Long> buildMap(StateExhibitor exhibitor,
