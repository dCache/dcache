 ...
 * <p>
 * Ideally, this would be based on SkelListBasedActivity, but the underlying Message currently
 * doesn't support requesting only a subset of all SRM Spaces.  So we must pull all Space
