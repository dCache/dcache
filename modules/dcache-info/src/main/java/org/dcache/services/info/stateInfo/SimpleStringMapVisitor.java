...
/**
 * Build a Map<String,String> that maps between a particular entry in a list of items and some
 * StringStateValue a fixed relative path from each list item.  For example, if the state tree
