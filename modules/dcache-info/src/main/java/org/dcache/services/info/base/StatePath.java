...
public class StatePath {
    ...
    /**
     * Convert a StatePath to it's corresponding string value.  This is identical to calling
     * toString(".");
     */
    @Override
    ...
    /**
     * Convert a StatePath to a String representation.  Each element is separated by the separator
     * String.
     *
    ...
    /**
     * Create a String representing this state with some initial elements removed. The number of
     * suppressed initial elements is the same as the number of elements in the prefix StatePath
     *
    ...
    /**
     * Create a new StatePath with an extra path element.  This method does no splitting of the
     * parameter: it is safe to pass a String with dots.
     * <p>
     * If you want to create a newChild with dot-splitting, one solution is to first create a
     * StatePath with the new path:
     * <p>
     * <pre>
    ...
    /**
     * Create a new StatePath with extra path elements; for example, if the path is representing
     * <tt>aa.bb</tt>, then <tt>path.newChild("cc")</tt> will return a new StatePath representing
     * <tt>aa.bb.cc</tt>
     * <p>
     *
    ...
    /**
     * Build a new StatePath that points to this StatePath node's parent node; for example, if
     * <tt>path</tt> is characterised by <tt>aa.bb.cc</tt> then <tt>path.parentPath()</tt> returns a
     * new StatePath that is characterised by <tt>aa.bb</tt>
     *
    ...
    /**
     * Check whether this path contains any branches; i.e., if the number of elements in the path is
