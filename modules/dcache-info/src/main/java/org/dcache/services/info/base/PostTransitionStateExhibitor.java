...
/**
 * The PostTransitionStateExhibitor provides a StateExhibitor that allows a visitor (a class
 * implementing StateVisitor) to visit what the state will be after a StateTransition has been
 * applied.
 */
public class PostTransitionStateExhibitor implements StateExhibitor {
    ...
    /**
     * The PreTransitionVisitor class visits the current state on behalf of some other StateVisitor.
     * The results are relayed to this other visitor after being adjusted to take into account the
     * StateTransition.
     */
