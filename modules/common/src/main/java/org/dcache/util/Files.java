...
/**
 * A collection of utility methods for handling files and directories in the host computer's
 * filesystem.
 */
public class Files {

    /**
     * Check that the supplied path exists on the local filesystem, that it is a file and that the
     * JVM process has permission to read the file.
     *
    ...
    /**
     * Check that the supplied path exists on the local filesystem, that it is a directory and that
     * the JVM process has permission to read the contents of this directory.
     *
