...
/**
 * This class represents a fully qualified attribute name (FQAN). FQANPrincipal is similar in
 * purpose to org.glite.security.voms.FQAN, except that the latter does not implement the Principal
