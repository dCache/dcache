...
/**
 * This principal represents an untrusted UID: the UID that the end-client wishes to become.
 * Typically no checks are made that the end-user is actually this UID; therefore it is recommended
 * not to make authorisation decisions based on this principal.
 *
 * @see UidPrincipal
 * @since 2.1
 */
