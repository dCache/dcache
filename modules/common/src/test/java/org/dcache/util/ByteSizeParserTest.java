...
public class ByteSizeParserTest {
    ...
    public void shouldParseNumberWithWhitespaceWithOptionalWhitespace() {
        long value = ByteSizeParser.using(isoSymbol()).withWhitespace(Whitespace.OPTIONAL)
              .parse("1 KiB");
    ...
    public void shouldParseNumberWithWhitespaceWithRequiredWhitespace() {
        long value = ByteSizeParser.using(isoSymbol()).withWhitespace(Whitespace.REQUIRED)
              .parse("1 KiB");
    ...
    public void shouldParseNumberWithFloorCoersion() {
        long value = ByteSizeParser.using(isoSymbol()).withCoersion(FLOOR)
              .parse("1.2KiB"); // 1228.8
    ...
    public void shouldParseNumberRoundUpWithRoundCoersion() {
        long value = ByteSizeParser.using(isoSymbol()).withCoersion(ROUND)
              .parse("1.2KiB"); // 1228.8
