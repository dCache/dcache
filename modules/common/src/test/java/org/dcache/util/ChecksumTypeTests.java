...
public class ChecksumTypeTests
{
    ...
    public void shouldCalculateCorrectSHA1Checksum() {
        Checksum checksum = SHA1.calculate("The quick brown fox jumps over the lazy dog".getBytes());
    ...
    public void shouldCalculateCorrectSHA256Checksum() {
        Checksum checksum = SHA256.calculate("The quick brown fox jumps over the lazy dog".getBytes());
        assertThat(checksum.getType(), is(SHA256));
        assertThat(checksum.getValue(), is(equalTo("d7a8fbb307d7809469ca9abcb0082e4f8d5651e46d3cdb762d02d0bf37c9e592")));
    }

    @Test
    public void shouldCalculateCorrectSHA512Checksum() {
        Checksum checksum = SHA512.calculate("The quick brown fox jumps over the lazy dog".getBytes());
        assertThat(checksum.getType(), is(SHA512));
        assertThat(checksum.getValue(), is(equalTo("07e547d9586f6a73f73fbac0435ed76951218fb7d0c8d788a309d785436bbb642e93a252a954f23912547d1e8a3b5ed6e1bfd7097821233fa0538f3db854fee6")));
    }
}
