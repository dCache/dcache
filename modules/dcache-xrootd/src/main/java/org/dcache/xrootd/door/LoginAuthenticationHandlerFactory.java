...
/**
 * Wraps the AuthenticationHandlerFactory required by the door with login capabilities.  Is
 * configured by spring initialization and SPI to create an instance of the
 * LoginAuthentciationHandler with a particular kind of delegation client (if any).
 */
public class LoginAuthenticationHandlerFactory implements ChannelHandlerFactory {
    ...
    /**
     * Handles logins with no authentication. Properties and delegation client are unused.
     *
