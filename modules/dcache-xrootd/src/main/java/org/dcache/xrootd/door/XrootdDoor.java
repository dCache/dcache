...
public class XrootdDoor
     ...
     * supported by the xrootd protocol, possible and not block the processing thread in the door,
    ...
    public int[] getMultipleFileStatuses(FsPath[] allPaths, Subject subject,
        ...
        for (int i = 0; i < allPaths.length; i++) {
            try {
                ...
                requestedAttributes.addAll(_pdp.getRequiredAttributes());
                FileAttributes attributes = getFileAttributes(allPaths[i], requestedAttributes,
                      pnfsHandler);
