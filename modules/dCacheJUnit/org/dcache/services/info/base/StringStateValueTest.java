...
public class StringStateValueTest extends InfoBaseTestHelper {
	...
	public void testAcceptVisitorStatePathStateVisitor() {
		...
		class TestStringVisitor implements StateVisitor {
			...
			String foundValue;
			StatePath foundPath;
			public void visitString( StatePath path, StringStateValue value) { foundPath = path; foundValue = value.toString();}
			public void visitInteger( StatePath path, IntegerStateValue value)  {broken = true;}
