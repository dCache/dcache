...
public class BooleanStateValueTests extends InfoBaseTestHelper {
	...
	class TestBooleanVisitor implements StateVisitor {
		...
		public void visitString( StatePath path, StringStateValue value) {_visitCalledWrongMethod = true;}
		public void visitInteger( StatePath path, IntegerStateValue value) {_visitCalledWrongMethod = true;}
		public void visitFloatingPoint( StatePath path, FloatingPointStateValue value) {_visitCalledWrongMethod = true;}
		public void visitCompositePreDescend( StatePath path, Map<String,String> metadata) {_visitCalledWrongMethod = true;}
		public void visitCompositePreLastDescend( StatePath path, Map<String,String> metadata) {_visitCalledWrongMethod = true;}
		public void visitCompositePostDescend( StatePath path, Map<String,String> metadata) {_visitCalledWrongMethod = true;}
		public void visitCompositePreSkipDescend( StatePath path, Map<String,String> metadata) {_visitCalledWrongMethod = true;}
		public void visitCompositePostSkipDescend( StatePath path, Map<String,String> metadata) {_visitCalledWrongMethod = true;}
	}
