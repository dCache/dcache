...
public class HsmRestoreTest {
    ...
    public void testRestoreNoLocations() throws Exception {
        ...
        /*
         * prepare reply from the pools
         */
        PoolFetchFileMessage poolFetchFileMessage1 = new PoolFetchFileMessage("pool1", _storageInfo, pnfsId);
        poolFetchFileMessage1.setFailed(17, "bad luck");
        PoolFetchFileMessage poolFetchFileMessage2 = new PoolFetchFileMessage("pool2", _storageInfo, pnfsId);
        poolFetchFileMessage1.setFailed(17, "bad luck");
        PoolFetchFileMessage poolFetchFileMessage3 = new PoolFetchFileMessage("pool3", _storageInfo, pnfsId);
        poolFetchFileMessage1.setReply(0, "");

        /*
         * prepare pools reply
         */
        GenericMockCellHelper.prepareMessage(new CellPath("pool1"), poolFetchFileMessage1);
        GenericMockCellHelper.prepareMessage(new CellPath("pool2"), poolFetchFileMessage2);
        GenericMockCellHelper.prepareMessage(new CellPath("pool3"), poolFetchFileMessage3);
        ...
        GenericMockCellHelper.registerAction("pool3", PoolFetchFileMessage.class,messageAction );
    ...
    private static class StageMessageAction implements MessageAction {
