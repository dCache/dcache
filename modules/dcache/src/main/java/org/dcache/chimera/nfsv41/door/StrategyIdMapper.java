...
public class StrategyIdMapper implements NfsIdMapping, RpcLoginService {
    ...
    public String gidToPrincipal(int id) {
        ...
        try {
            ...
            _log.info("Failed to reverseMap for gid {} : {}", id, e);
        }
        return NOBODY;
    }
    ...
    public int principalToGid(String name) {
        try {
            ...
            _log.info("Failed to map pringipal {} : {}", name, e);
        }
        return -1;
    }
    ...
    public String uidToPrincipal(int id) {
        ...
        try {
            ...
            for (Principal principal : principals) {
             ...
             _log.info("Failed to reverseMap for uid {} : {}", id, e);
        }
        return NOBODY;
    }
    ...
    public Subject login(Principal principal) {
        ...
        try {
            ...
            _log.info("Failed to login for : {} : {}", principal.getName(), e.toString());
        }
