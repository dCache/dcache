...
public class RendezvousPoolManagerHandler implements SerializablePoolManagerHandler {
    ...
    public RendezvousPoolManagerHandler(CellAddressCore serviceAddress,
    ...
    private <T extends Serializable> ListenableFuture<List<T>> allSuccessful(CellEndpoint endpoint,
          Serializable msg, Class<T> reply, long timeout) {
        return Futures.successfulAsList(
              backends.stream().map(b -> submit(endpoint, new CellPath(b), msg, reply, timeout))
                    .collect(toList()));
    }
    ...
    protected static class Version implements SerializablePoolManagerHandler.Version {
        ...
        public boolean equals(Object o) {
            ...
            return serviceAddress.equals(version.serviceAddress) && backends.equals(
                  version.backends);
        }
