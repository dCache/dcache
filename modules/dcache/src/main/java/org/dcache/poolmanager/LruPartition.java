...
public class LruPartition extends Partition {
    ...
    /**
     * Pool name to access order. Making this static will mean that all instances of LruPartition
     * will share this information. It will also ensure that this information is not serialized,
     * meaning that multiple deserialized instances preserve this information.
     */
    ...
    public SelectedPool selectWritePool(CostModule cm,
        ...
        return new SelectedPool(select(freePools, _lastWrite),
              new AvailableSpaceAssumption(preallocated));
    }
