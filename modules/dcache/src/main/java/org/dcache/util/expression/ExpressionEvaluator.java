...
public class ExpressionEvaluator {
    ...
    /**
     * The expression must be type annotated and correct before the interpreter is invoked.
     * Otherwise the interpreter will fail with IllegalArgumentException.
     */
        ...
        switch (expression.getToken()) {
            ...
            case EQ:
                switch (expression.get(0).getType()) {
                    ...
                    case STRING:
                        return
                              evaluateString(expression.get(0)).equals(
            ...
            case NOT_MATCH:
                return !evaluateString(expression.get(0)).matches(
                      evaluateString(expression.get(1)));
            default:
