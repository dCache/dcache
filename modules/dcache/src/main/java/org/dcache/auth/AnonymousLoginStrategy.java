 ...
 * behaviour follows the old door behaviour - depending on configuration, a NOBODY user, a ROOT user
 * or a user based on the configured uid/gid is returned as a result of the login operation.
 *
 * @author tzangerl
 */
public class AnonymousLoginStrategy implements LoginStrategy {
    ...
    /**
     * Parses a string on the form UID:GID(,GID)* and returns a corresponding Subject.
     */
