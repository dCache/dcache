...
public class ChecksumModuleV1
    ...
    private static final Map<ChecksumType, String> CHECKSUM_NAMES = ImmutableMap.of(ADLER32,
          "adler32", MD5_TYPE, "md5");
    ...
    private Set<Checksum> computeChecksums(RepositoryChannel channel,
        ...
        LOGGER.debug("Computed checksum, length {}, checksum {} in {} ms{}", pos,
              checksums.toString(),
