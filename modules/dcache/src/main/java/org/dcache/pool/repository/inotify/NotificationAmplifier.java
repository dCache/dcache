...
/**
 * This class is responsible for accepting inotify events that target some specific file and emits
 * events that target that file and the corresponding event for the parent directory.
 */
public class NotificationAmplifier extends AbstractStateChangeListener implements
      CellMessageReceiver {
