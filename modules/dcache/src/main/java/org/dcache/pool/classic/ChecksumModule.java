...
public interface ChecksumModule {
    ...
    /**
     * Verify the integrity of a file identified as broken.  If knownChecksums is empty then the
     * replica's data is assumed to be correct.
     * <p>
     * Checksums may be calculated in addition to those required to verify the knownChecksums.  Any
     * such additional checksums are returned and are intended to be stored locally and sent to the
     * namespace.
     *
     ...
     * @throws InterruptedException        if the pool is shut down during the verification
     *                                     process.
     */
    @Nonnull
