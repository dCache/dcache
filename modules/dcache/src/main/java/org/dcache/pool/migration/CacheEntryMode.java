...
/**
 * Immutable record class combining a list of sticky records and a CacheEntry state update.
 * Instances of this class describe how the state of source or target replica is to be updated after
 * the transfer.
 */
