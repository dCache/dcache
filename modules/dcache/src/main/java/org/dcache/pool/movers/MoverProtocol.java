...
public interface MoverProtocol {
    ...
    /**
     * Get number of bytes transfered. The number of bytes may exceed total file size if client does
     * some seek requests in between.
     *
    ...
    /**
     * Get the number of bytes expected to be transferred, if known.  Returns null if that value is
     * unknown.
     */
    @Nullable
    ...
    /**
     * Get time between transfers begin and end. If Mover is sill active, then current time used as
     * end.
     *
