...
/**
 * Base class for BerkeleyDB backed MetaDataStore implementations.
 *
 ...
 */
public abstract class AbstractBerkeleyDBMetaDataRepository implements MetaDataStore, EnvironmentAware
{
     ...
     */
    private MetaDataRepositoryDatabase database;

    /**
     * The BerkeleyDB database to use.
     */
    protected MetaDataRepositoryViews views;


    public AbstractBerkeleyDBMetaDataRepository(Path directory, boolean readOnly) throws IOException
    {
    ...
    {
        try {
            database = new MetaDataRepositoryDatabase(properties, dir.toFile(), readOnly);
            views = new MetaDataRepositoryViews(database);
