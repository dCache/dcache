...
public class CellInfoContainer {
    ...
    public synchronized void addPattern(String groupClass, String group, String patternName,
          String pattern) {
        Map<String, Map<String, Object>> poolGroupMap =
              _poolGroupClassHash.get(groupClass);
        if (poolGroupMap == null) {
            ...
            if (pattern != null) {
                if (!patternEntry.pattern.pattern().equals(pattern)) {
                    throw new
                          ...
                          "Conflict in pattern (name in use with different pattern)");
                }
            }
        }
    ...
    public synchronized String getInfo() {
        ...
        for (Map.Entry<String, PatternEntry> entry :
            ...
            sb.append("  ").append(patternName).append("(").append(pattern.pattern()).append(")")
                  .append("\n");
