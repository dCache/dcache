...
public class PAMAuthentificator extends CellAdapter {
    ...
    private UserMetaDataProvider initUserServiceProvider(String className)
        ...
        Class<? extends UserMetaDataProvider> exec = Class.forName(className)
              .asSubclass(UserMetaDataProvider.class);
    ...
    public void getInfo(PrintWriter pw) {
        try {
            ...
            pw.println("           PAM loaded : " + (_pam == null ? "Not requested"
                  : (String.valueOf(_pam.pamOk()))));
            ...
            switch (_userServiceType) {
                ...
                case USER_SERVICE_CLASS:
                    pw.println(
                          " user metadata   Class  : " + _userServiceProvider.getClass().getName());
...
//VP  Map map = _userServiceProvider.getUserMetaData( userName , attrList ) ;
        Map<String, String> map = _userServiceProvider.getUserMetaData(principal, userName,
              attrList);
