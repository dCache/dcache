...
/**
 * Simple wrapper arround HTMLWriter to expose the functionality in a builder style interface.
 * Rather than writing the HTML document to another writer, the builder returns the finished HTML
