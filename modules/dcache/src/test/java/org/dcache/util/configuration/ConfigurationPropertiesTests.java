...
public class ConfigurationPropertiesTests {
    ...
    private static final String SIMPLE_SYNONYM_OF_DEPRECATED_VALUE =
    ...
    public void testObsoleteWithErrorPropertyPut() {
        ...
        assertEquals("Property " + OBSOLETE_PROPERTY_W_ERROR_NAME + ": " +
                    "please remove this assignment; " + OBSOLETE_PROPERTY_W_ERROR_VALUE,
              _log.get(0).getFormattedMessage());
    }
    ...
    public void testGetReplacementExpandingWithPreamble() {
        ...
        assertEquals(prefix + SIMPLE_PROPERTY_VALUE,
              _standardProperties.getValue(EXPANDING_PROPERTY_NAME));
    }
    ...
    public void testGetReplacementExpandingWithPostamble() {
        ...
        assertEquals(SIMPLE_PROPERTY_VALUE + postfix,
              _standardProperties.getValue(EXPANDING_PROPERTY_NAME));
    }
    ...
    public void testLoadEmptyContentsIsEmpty() throws IOException {
        ...
        assertEquals("check size is zero after loading empty data", 0,
              _initiallyEmptyProperties.size());
    }
    ...
    public void testLoadSingleProperty() throws IOException {
        ...
        assertEquals("check size is zero after loading empty data", 1,
              _initiallyEmptyProperties.size());
        assertEquals(SIMPLE_PROPERTY_VALUE,
              _initiallyEmptyProperties.getProperty(SIMPLE_PROPERTY_NAME));
    }
