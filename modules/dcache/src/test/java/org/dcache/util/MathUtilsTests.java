...
import static org.dcache.util.MathUtils.absModulo;
...
public class MathUtilsTests {
    ...
    public void testAddWithInfinityOverflow() {
        assertThat(addWithInfinity(Long.MAX_VALUE / 2 + 100, Long.MAX_VALUE / 2 + 100),
              is(Long.MAX_VALUE));
    }
    ...
    public void testSubWithInfinityUnderflow() {
        assertThat(subWithInfinity(-Long.MAX_VALUE / 2 - 100, Long.MAX_VALUE / 2 + 100),
              is(Long.MIN_VALUE));
    }
