...
public class SubnetTest {
    ...
    public void testToString() {
        ...
        assertEquals("1234:1234:1234:1234:1234:1234:1234:1234/96", subnet.toString());
    ...
    public void testMatchAll() {
        Subnet subnet = Subnet.create();
        assertTrue(subnet.contains(InetAddresses.forString("192.168.0.1")));
        assertTrue(subnet.contains(InetAddresses.forString("bad:f00d::1")));
        subnet = Subnet.create("0.0.0.0/0");
        assertTrue(subnet.contains(InetAddresses.forString("192.168.0.1")));
        assertTrue(subnet.contains(InetAddresses.forString("bad:f00d::1")));
        subnet = Subnet.create("::/0");
