 ...
 * intended to facilitate unit-testing of objects that implement the Serializable interface: if we
 * want to check that we can deserialise objects and catch if we break serialisable compatibility.
 */
