...
public class ArrayOfTPutFileRequest  implements java.io.Serializable {
    ...
    public ArrayOfTPutFileRequest(
           org.dcache.srm.v2_2.TPutFileRequest[] requestArray) {
     ...
     * @return requestArray
     */
    public org.dcache.srm.v2_2.TPutFileRequest[] getRequestArray() {
        return requestArray;
    }
     ...
     * @param requestArray
     */
    public void setRequestArray(org.dcache.srm.v2_2.TPutFileRequest[] requestArray) {
        this.requestArray = requestArray;
    }

    public org.dcache.srm.v2_2.TPutFileRequest getRequestArray(int i) {
        return this.requestArray[i];
    }

    public void setRequestArray(int i, org.dcache.srm.v2_2.TPutFileRequest _value) {
