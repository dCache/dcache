...
public class TFileStorageType implements java.io.Serializable {
    ...
    public static TFileStorageType fromValue(java.lang.String value)
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(TFileStorageType.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://srm.lbl.gov/StorageResourceManager", "TFileStorageType"));
    }
    /**
