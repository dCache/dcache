...
public class ArrayOfTGetRequestFileStatus  implements java.io.Serializable {
    private static final long serialVersionUID = 3060328719311292207L;
    private org.dcache.srm.v2_2.TGetRequestFileStatus[] statusArray;

    public ArrayOfTGetRequestFileStatus() {
    }

    public ArrayOfTGetRequestFileStatus(
           org.dcache.srm.v2_2.TGetRequestFileStatus[] statusArray) {
     ...
     * @return statusArray
     */
    public org.dcache.srm.v2_2.TGetRequestFileStatus[] getStatusArray() {
        return statusArray;
    }
     ...
     * @param statusArray
     */
    public void setStatusArray(org.dcache.srm.v2_2.TGetRequestFileStatus[] statusArray) {
        this.statusArray = statusArray;
    }

    public org.dcache.srm.v2_2.TGetRequestFileStatus getStatusArray(int i) {
        return this.statusArray[i];
    }

    public void setStatusArray(int i, org.dcache.srm.v2_2.TGetRequestFileStatus _value) {
