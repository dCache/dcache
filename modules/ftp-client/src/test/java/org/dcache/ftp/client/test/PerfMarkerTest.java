...
public class PerfMarkerTest extends TestCase {
    ...
    private static Logger logger =
          LoggerFactory.getLogger(PerfMarkerTest.class);
    ...
    /**
     * Test interesting cases of perf marker construction with invalid argument, and ensure that
     * IllegalAgumentException is thrown.
     **/
	...
	*/
    ...
    /**
     * test perf marker construction and get() and has() methods. "in" is constructor parameter,
     * other params describe the expected object examination behavior.
     **/
    ...
    /**
     * Assume that arg represent an invalid message; ensure that constructor throws
