...
public class HostPortListTest extends TestCase {
    ...
    private static Logger logger =
          LoggerFactory.getLogger(HostPortListTest.class);
    ...
    /**
     * make sure that message "msg" is properly converted to the SPOR command argument "arg"
     **/
    ...
    /**
     * assume this is a bad argument to HostPortList constructor. make sure the constructor throws
     * an exception.
     **/
