...
public class FileInfoTest extends TestCase {
    ...
    public void testSpace() throws Exception {
        FileInfo f3 = new FileInfo(
              "drwxrwxr-x    2 gawor    globus   512 Dec 26  2001 gatekeeper file 2");
    ...
    public void testFileWithDate() throws Exception {
        FileInfo f4 = new FileInfo(
              "drwxrwxr-x    2 gawor    globus   512 Dec 26  2001 gatekeeper-2001");
    ...
    public void testFileWithDateWithSpace() throws Exception {
        FileInfo f4 = new FileInfo(
              "drwxrwxr-x    2 gawor    globus   512 Dec 26  2001 gatekeeper-2001   a b c  ");
    ...
    public void testSoftLink() throws Exception {
        FileInfo f4 = new FileInfo(
              "lrwxrwxrwx    1 root     root           10 Nov  2  2001 mouse -> /dev/psaux");
