...
public class ByteRangeListTest extends TestCase {
    ...
    /**
     * Test merging ByteRange to ByteRangeList. Systematic test of most cases. Tests merge() and
     * toFtpCmdArgument(). Assure that merge() does not modify parameter objects.
     **/
    public void test1() {
        Vector v = new Vector();
    ...
    /**
     * Ad hoc tests of interesting merge cases. Test merging several ranges into 1 list. Test
     * merge() and toFtpCmdArgument().
     **/
    public void test3() {
        //merge 2 -> 1
        Vector v = new Vector();
    ...
    /**
     * Create ByteRangeList from vector v, merge with new ByteRange(from, to), assure it renders
     * toFtpCmdArgument() as expectedResult and that original vector and range did not change. Test
     * merge(Vector), merge(ByteRange), toFtpCmdArgument() and
     **/
    ...
    /**
     * Merge vector into a new ByteRangeList. Test merge(ByteRange), merge(Vector),
     * toFtpCmdArgument().
     **/
