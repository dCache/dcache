...
public class OptionMap<Type> {
    ...
    abstract static class ConstrainedFactoryImpl<Type> implements Factory<Type>,
    ...
    public static void main(String[] argList) {
        ...
        OptionMap<Integer> intMap = new OptionMap<>(new IntFactory(intAttrs),
              args);
        System.out.println(intMap.get("attr1") + intMap.get("attr3") + intMap.get("attr2"));

        OptionMap<String> sMap = new OptionMap<>(new StringFactory(),
              args);
