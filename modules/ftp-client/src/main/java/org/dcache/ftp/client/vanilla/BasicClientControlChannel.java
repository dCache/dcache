...
/**
 * Basic subset of client side control channel functionality, enough to implement the part of
 * transfer after sending transfer command (RETR) up until receiving 200 reply.
 **/
public abstract class BasicClientControlChannel {
    ...
    /**
     * Block until reply is waiting in the control channel, or after timeout (maxWait), or when flag
     * changes to true. If maxWait == WAIT_FOREVER, do not timeout.
     *
