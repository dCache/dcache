...
/**
 * Reference implementation of DataSink. It can be used with non-parallel transfers. It cannot be
 * used with Extended Block Mode because it uses implicit assumption that data arrives in correct
