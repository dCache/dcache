...
public abstract class Options {
    ...
    /**
     * Subclasses should implement this method. It should return the right side of the options line,
     * in the format of OPTS command. It should not include the command name.
     */
