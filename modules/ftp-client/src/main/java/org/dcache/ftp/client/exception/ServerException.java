 ...
 * For instance, the server did not understand command, or could not read file. Note that here
 * "server" can mean either a remote server, or the local internal server (FTPServerFacade).
 **/
public class ServerException extends FTPException {
    ...
    /**
     * The communication from the server was not understood, possibly because of incompatible
     * protocol.
     **/
