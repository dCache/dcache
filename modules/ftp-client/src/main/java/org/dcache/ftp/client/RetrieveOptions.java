...
/**
 * Options to the command RETR, as defined in GridFTP. In client-server transfers, this
 * implementation does not support starting/min/max parallelism. All three values must be equal. In
 * third party transfers, this is not necessary.
 */
