 ...
 * Scitokens "scope" claim.
 */
public class ScitokensScope implements AuthorisationSupplier {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ScitokensScope.class);
    ...
    ScitokensScope(Operation operation, String path) {
        this.operation = requireNonNull(operation);
        this.path = requireNonNull(path);
        LOGGER.debug("SciTokenScope created: op={} path={}", operation, path);
    }

    public ScitokensScope(String scope) throws InvalidScopeException {
    ...
    public boolean equals(Object other) {
        if (!(other instanceof ScitokensScope)) {
            return false;
        }

        ScitokensScope otherScope = (ScitokensScope) other;
