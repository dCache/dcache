...
/**
 * A FileTransferAgent that delegates the actual activity to some other FileTransferAgent based on
 * Java SPI.  This class also supports the MultiProtocolFileTransfer interface by injecting itself
 * as the FileTransferAgent the transfer should use.
 */
    ...
    public FileTransfer upload(File source, URI destination) {
        ...
        if (agent == null) {
            throw new IllegalArgumentException(
                  "Scheme " + destination.getScheme() + " not supported.");
        }
