...
public class PnfsListLabelsMessage extends PnfsMessage {
    ...
    private Collection<LabelsEntry> _entries = new ArrayList<>();
     ...
     */
    public PnfsListLabelsMessage(Glob pattern,
          Range<Integer> range) {
    ...
    public void addEntry(String name, FileAttributes attr) {
        _entries.add(new LabelsEntry(name));
    }

    /**
     * Sets a new entry list.
     */
    public void setEntries(Collection<LabelsEntry> entries) {
        _entries = entries;
    }
     ...
     */
    public Collection<LabelsEntry> getEntries() {
        return _entries;
    }
