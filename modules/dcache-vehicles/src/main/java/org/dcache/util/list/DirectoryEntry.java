...
/**
 * Encapsulates a directory entry. A DirectoryEntry consists of a file name, the PNFS ID of the file
 * and an optional FileAttributes.
 * <p>
 * The DirectoryStream interface provides a stream of DirectoryEntries.
 */
