...
/**
 * FileNotOnlineCacheException : file is not online and have to be staged from tape to a pool, but
 * user has no permission to perform staging. Introduced in 'Tape Protection'-feature.
 */
