...
/**
 * Thrown when accessing a locked resource. This is typically a transient error and retrying later
 * maybe allow the operation to succeed without administrative intervention.
 */
