...
/**
 * Request cannot proceed due to a lack of space due to pool-manager configuration.  This exception
 * is the SpaceException equivalent to CacheException.NO_POOL_CONFIGURED.
 */
