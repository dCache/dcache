        ...
        CuratorFrameworkAware, CellIdentityAware, CellLifeCycleAware
{
    ...
    /** Conversion from dCache internal events to frontend-specific external representation. */
    //private static final Map<EventType,EventFlag> EVENT_AS_FLAG = new EnumMap(EventType.class);
    ...
    /*
    static {
        EVENT_AS_FLAG.put(EventType.IN_ACCESS,        EventFlag.IN_ACCESS);
        EVENT_AS_FLAG.put(EventType.IN_ATTRIB,        EventFlag.IN_ATTRIB);
        EVENT_AS_FLAG.put(EventType.IN_CLOSE_NOWRITE, EventFlag.IN_CLOSE_NOWRITE);
        EVENT_AS_FLAG.put(EventType.IN_CLOSE_WRITE,   EventFlag.IN_CLOSE_WRITE);
        EVENT_AS_FLAG.put(EventType.IN_CREATE,        EventFlag.IN_CREATE);
        EVENT_AS_FLAG.put(EventType.IN_DELETE,        EventFlag.IN_DELETE);
        EVENT_AS_FLAG.put(EventType.IN_DELETE_SELF,   EventFlag.IN_DELETE_SELF);
        EVENT_AS_FLAG.put(EventType.IN_MODIFY,        EventFlag.IN_MODIFY);
        EVENT_AS_FLAG.put(EventType.IN_MOVED_FROM,    EventFlag.IN_MOVED_FROM);
        EVENT_AS_FLAG.put(EventType.IN_MOVED_TO,      EventFlag.IN_MOVED_TO);
        EVENT_AS_FLAG.put(EventType.IN_MOVE_SELF,     EventFlag.IN_MOVE_SELF);
        EVENT_AS_FLAG.put(EventType.IN_OPEN,          EventFlag.IN_OPEN);
        EVENT_AS_FLAG.put(EventType.OVERFLOW,         EventFlag.IN_Q_OVERFLOW);
    }
*/
