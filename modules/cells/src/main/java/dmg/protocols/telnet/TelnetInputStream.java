...
/**
 * The Telnet input stream builds the layer between a telnet input stream and the application layer.
 * If it is used as Filter for higher level Streams, is simply extracts the telnet controls out of
 * the stream. Otherwise the 'getNext' method returns a byte array which represents the control
 * characters and an CharacterObject otherwise.
 *
