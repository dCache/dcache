...
/**
 * Wrapper for CuratorFramework that maintains the CDC as well as injects a default executor for
 * callbacks.
 */
public class CellCuratorFramework implements CuratorFramework {
    ...
    private class CreateBuilderDecorator implements CreateBuilder {
        ...
        public ProtectACLCreateModeStatPathAndBytesable<String> creatingParentsIfNeeded() {
            return new ProtectACLCreateModeStatPathAndBytesableDecorator<>(
                  inner.creatingParentsIfNeeded());
        }

        @Override
        public ProtectACLCreateModeStatPathAndBytesable<String> creatingParentContainersIfNeeded() {
            return new ProtectACLCreateModeStatPathAndBytesableDecorator<>(
                  inner.creatingParentContainersIfNeeded());
        }
        ...
        public ACLCreateModeStatBackgroundPathAndBytesable<String> withProtection() {
            return new ACLCreateModeStatBackgroundPathAndBytesableDecorator<>(
                  inner.withProtection());
        }
        ...
        public ErrorListenerPathAndBytesable<String> inBackground(BackgroundCallback callback) {
            return new ErrorListenerPathAndBytesableDecorator<>(
                  inner.inBackground(wrap(callback), executor));
        }
        ...
        public ErrorListenerPathAndBytesable<String> inBackground(BackgroundCallback callback,
              Object context) {
            return new ErrorListenerPathAndBytesableDecorator<>(
                  inner.inBackground(wrap(callback), context, executor));
        }
    ...
    private class DeleteBuilderDecorator implements DeleteBuilder {
        ...
        public ErrorListenerPathable<Void> inBackground(BackgroundCallback callback) {
            return new ErrorListenerPathableDecorator<>(
                  inner.inBackground(wrap(callback), executor));
        }
    ...
    private class ExistsBuilderDecorator extends ExistsBuilderMainDecorator implements
          ExistsBuilder {
    ...
    private class TransactionCreateBuilderDecorator implements TransactionCreateBuilder {
        ...
        public TransactionCreateBuilderDecorator(
              TransactionCreateBuilder<CuratorTransactionBridge> inner) {
            this.inner = inner;
        }
    ...
    private class TransactionDeleteBuilderDecorator implements TransactionDeleteBuilder {
        ...
        public TransactionDeleteBuilderDecorator(
              TransactionDeleteBuilder<CuratorTransactionBridge> inner) {
            this.inner = inner;
        }
    ...
    private class TransactionSetDataBuilderDecorator implements TransactionSetDataBuilder {
        ...
        public TransactionSetDataBuilderDecorator(
              TransactionSetDataBuilder<CuratorTransactionBridge> inner) {
            this.inner = inner;
        }
        ...
        public PathAndBytesable<CuratorTransactionBridge> withVersion(int version) {
            return new PathAndBytesableCuratorTransactionBridgeDecorator(
                  inner.withVersion(version));
        }
    }
    ...
    private class TransactionCheckBuilderDecorator implements TransactionCheckBuilder {
        ...
        public TransactionCheckBuilderDecorator(
              TransactionCheckBuilder<CuratorTransactionBridge> inner) {
            this.inner = inner;
        }
    ...
    private class ProtectACLCreateModeStatPathAndBytesableDecorator<T> implements
          ProtectACLCreateModeStatPathAndBytesable<T> {

        private final ProtectACLCreateModeStatPathAndBytesable<T> inner;

        public ProtectACLCreateModeStatPathAndBytesableDecorator(
              ProtectACLCreateModeStatPathAndBytesable<T> inner) {
            this.inner = inner;
        }
    ...
    private class ACLCreateModeBackgroundPathAndBytesableDecorator<T> implements
          ACLCreateModeBackgroundPathAndBytesable<T> {

        private final ACLCreateModeBackgroundPathAndBytesable<T> inner;

        public ACLCreateModeBackgroundPathAndBytesableDecorator(
              ACLCreateModeBackgroundPathAndBytesable<T> inner) {
            this.inner = inner;
        }
    ...
    private class ACLCreateModeStatBackgroundPathAndBytesableDecorator<T> implements
          ACLCreateModeStatBackgroundPathAndBytesable<T> {

        private final ACLCreateModeStatBackgroundPathAndBytesable<T> inner;

        public ACLCreateModeStatBackgroundPathAndBytesableDecorator(
              ACLCreateModeStatBackgroundPathAndBytesable<T> inner) {
            this.inner = inner;
        }
        ...
        public ACLCreateModeBackgroundPathAndBytesable<T> storingStatIn(Stat stat) {
            return new ACLCreateModeBackgroundPathAndBytesableDecorator<>(
                  inner.storingStatIn(stat));
        }
    }
    ...
    private static class ErrorListenerPathAndBytesableDecorator<T> implements
          ErrorListenerPathAndBytesable<T> {
        ...
        @Override
        public PathAndBytesable<T> withUnhandledErrorListener(
              UnhandledErrorListener unhandledErrorListener) {
            return new PathAndBytesableDecorator<>(
                  inner.withUnhandledErrorListener(unhandledErrorListener));
        }
    ...
    private class PathAndBytesableCuratorTransactionBridgeDecorator implements
    ...
    private class CreateBackgroundModeStatACLableDecorator implements
    ...
    private class ACLBackgroundPathAndBytesableDecorator<T> implements
    ...
    private static class ACLCreateModePathAndBytesableDecorator<T> implements
    ...
    private static class ErrorListenerPathableDecorator<T> implements ErrorListenerPathable<T> {
        ...
        @Override
        public Pathable<T> withUnhandledErrorListener(
              UnhandledErrorListener unhandledErrorListener) {
            return new PathableDecorator<>(
                  inner.withUnhandledErrorListener(unhandledErrorListener));
        }
    ...
    private class PathableCuratorTransactionBridgeDecorator implements
    ...
    private class GetDataWatchBackgroundStatableDecorator implements
    ...
    private class VersionPathAndBytesableCuratorTransactionBridgeDecorator implements
          VersionPathAndBytesable<CuratorTransactionBridge> {

        private final VersionPathAndBytesable<CuratorTransactionBridge> inner;

        public VersionPathAndBytesableCuratorTransactionBridgeDecorator(
              VersionPathAndBytesable<CuratorTransactionBridge> inner) {
            this.inner = inner;
        }
