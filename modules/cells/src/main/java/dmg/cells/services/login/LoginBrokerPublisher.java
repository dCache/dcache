...
public class LoginBrokerPublisher
      ...
      implements CellCommandListener, CellMessageReceiver, CellEventListener, CellLifeCycleAware,
      CellInfoProvider {
     ...
     * copied and the field must be updated.
     */
    ...
    /**
     * Sets the address of the door being published. If null or a wildcard address is provided, all
     * interfaces of the door are published. If an address is provided, the canonical host is
     * resolved and published with the address. If a name is provided, the name is resolved to an
     * address and published together with the name.
     */
