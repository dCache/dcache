...
/**
 * Classes implementing this method receive Cell life cycle notifications.
 */
public interface CellLifeCycleAware {
    ...
    /**
     * Called just before the cell is killed. At this point new messages can no longer be received,
     * but the message delivery threads are still active and queued messages will be delivered.
     * Curator callbacks can also still be delivered.
     */
     ...
     * {@code afterStart} if the cell is initialized with a setup during startup. If a setup is
     * loaded or reloaded subsequently, the method is called before executing that setup.
     * <p>
