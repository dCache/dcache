...
//  private final static long sBox[256 * 4] =  {
  ...
  0xb74e6132, 0xce77e25b, 0x578fdfe3, 0x3ac372e6,
   ...
   private void createKey(){
      ...
      System.arraycopy( sBox , 0 , _S , 0 , sBox.length ) ;
      System.arraycopy( pBox , 0 , _P , 0 , pBox.length ) ;
    ...
    public void encrypt( byte [] in  , int inOff ,
        ...
        out[outOff+3] = (byte) ( ( dout[0] >>>  0  ) & 0xff );
        out[outOff+4] = (byte) ( ( dout[1] >>> 24  ) & 0xff );
        out[outOff+5] = (byte) ( ( dout[1] >>> 16  ) & 0xff );
        out[outOff+6] = (byte) ( ( dout[1] >>>  8  ) & 0xff );
