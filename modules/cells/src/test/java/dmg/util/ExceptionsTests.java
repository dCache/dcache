...
public class ExceptionsTests
{
    ...
    public void shouldWrapWithCauseInSimpleCase()
    {
        ...
        assertThat(wrapped.getCause(), is((Throwable)cause));
        assertThat(wrapped.getClass(), is(equalTo((Class)IOException.class)));
    ...
    public void shouldWapWithMessageIfExceptionHasNoStringThrowableConstructor()
    {
        ...
        assertThat(wrapped.getClass(), is(equalTo((Class)SocketException.class)));
    ...
    public void shouldUseBroaderExceptionIfCannotWrap()
    {
        ...
        assertThat(wrapped.getMessage(), is(equalTo("Wrapped message")));
        assertThat(wrapped.getCause(), is((Throwable)cause));
        assertThat(wrapped.getClass(), is(equalTo((Class)Exception.class)));
