...
public class CellRouteTest
{
    ...
    public void shouldOnlyHashCellAndDomain() throws Exception
    {
        ...
        CellRoute route3 = new CellRoute("a@c", new CellAddressCore("gateway1"), CellRoute.EXACT);
        assertThat(route1.hashCode(), not(is(route3.hashCode())));

        CellRoute route4 = new CellRoute("c@b", new CellAddressCore("gateway1"), CellRoute.EXACT);
        assertThat(route1.hashCode(), not(is(route4.hashCode())));

        CellRoute route5 = new CellRoute("", new CellAddressCore("gateway1"), CellRoute.DUMPSTER);
        CellRoute route6 = new CellRoute("", new CellAddressCore("gateway1"), CellRoute.DEFAULT);
