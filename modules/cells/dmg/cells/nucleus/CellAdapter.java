...
public class   CellAdapter 
   ...
   private Gate        _startGate = new Gate(false) ;
   ...
   private Object      _pinBoardLock   = new Object();
   /**
...
//          esay( name + " : "+e.toString() ) ;
   ...
   public CellVersion getCellVersion(){
      ...
      return new CellVersion(pv == null ? "cells" : pv , "CA-$Revision: 1.22.2.4 $") ;
   }
   ...
   public String ac_info( Args args ) throws Exception {
      ...
      if( lng ){
        ...
        HashMap map = _nucleus.getWaitQueue() ;
