...
/**
 * Mandatory Attributes. based: Network File System (NFS) version 4 Protocol, RFC3530
 *
...
public enum FileAttribute {
    ...
    public static FileAttribute valueOf(int attribute) throws IllegalArgumentException {
        ...
        throw new IllegalArgumentException(
              "Illegal argument (value of file attribute): " + attribute);
    }

    /**
     * @param attributes Attributes bit mask
