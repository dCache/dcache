...
/**
 * Represents a map based on a somehow defined key/value source (e.g. configuration file) depending
 * on the given MapPredicate this may be a one to many relationship.
 *
