...
public class IGTFInfoFileTest {
    ...
    public void shouldParseGermanGrid() throws Exception {
        ...
        assertThat(info.getUrl(),
              is(equalTo(URI.create("http://grid.fzk.de/cgi-bin/welcome_ca.pl"))));
        assertThat(info.getCRLUrls(),
              hasItem(URI.create("http://gridka-ca.kit.edu/crl/gridka-crl.pem")));
        ...
        assertThat(info.getSHA1FP0(),
              is(equalTo(new BigInteger("82A7F97C39CD21189E0E392751D605ACA7F6BDBD", 16))));
        assertThat(info.getSubjectDN(),
              is(equalTo(new GlobusPrincipal("/C=DE/O=GermanGrid/CN=GridKa-CA"))));
    }
