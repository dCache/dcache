...
/**
 * This account plugin succeeds if the specified uid principal is present fails otherwise
 *
 * @author timur
 */
public class CheckUIDAccountPlugin implements GPlazmaAccountPlugin {
    ...
    /**
     * thread unsafe way of checking if account method of any instance of the CheckUIDAccountPlugin
     * was called since the last reset was called
     *
     * @return the called
     */
