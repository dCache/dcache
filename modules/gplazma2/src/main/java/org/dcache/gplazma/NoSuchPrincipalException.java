...
/**
 * This class represents that an attempt to do a forward identity lookup (convert an arbitrary
 * Principal to either a UID or GID principal) or the reverse identity lookup (discovering the set
 * of principals that map to the supplied UID or GID) has failed.
 */
