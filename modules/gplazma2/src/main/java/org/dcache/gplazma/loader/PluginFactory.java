...
/**
 * A Class implementing PluginFactory is responsible for instantiating a GPlazmaPlugin from the
 * Class object. This involves calling the correct constructor (via reflection) and passing
