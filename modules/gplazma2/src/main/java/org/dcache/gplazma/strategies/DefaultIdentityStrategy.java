...
/**
 * The DefaultIdentityStrategy tries each of the supplied plugins in turn when answering either a
 * map or a reverseMap operation.  The reply from the first plugin that maps or reverseMaps the
 * supplied principal is used.
 */
