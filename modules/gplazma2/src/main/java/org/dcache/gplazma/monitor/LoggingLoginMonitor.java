...
/**
 * This is a LoginMonitor that stores logging information in the logger at debug level.
 */
public class LoggingLoginMonitor extends IgnoringLoginMonitor {
    ...
    public void authBegins(Set<Object> publicCredentials,
        ...
        _log.debug("phase starts (public: {}, private: {}, principals: {})", publicCredentials,
              privateCredentials,
              principals);
    }
    ...
    public void authPluginBegins(String name, ConfigurationItemControl control,
        ...
        _log.debug("calling (publicCred: {}, privateCred: {}, principals: {})", publicCredentials,
              privateCredentials,
              principals);
    }
