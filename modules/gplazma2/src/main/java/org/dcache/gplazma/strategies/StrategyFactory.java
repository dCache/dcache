...
public abstract class StrategyFactory {
    ...
    /**
     * @return an instance of the StrategyFactory, by default it is org.dcache.gplazma.configuration.parser.DefaultConfigurationParserFactory
    ...
    public static StrategyFactory getInstance()
        ...
        try {
            ...
            throw new FactoryConfigurationException("parser factory class is not concrete class",
                  ie);
        } catch (IllegalAccessException iae) {
            throw new FactoryConfigurationException(
                  "do not have access to parser factory constructor", iae);
        }
    }
     ...
     * @return an instanc of the StrategyFactory specified by the factoryClassName
     */
