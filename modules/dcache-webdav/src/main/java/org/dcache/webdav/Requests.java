...
public class Requests {
    ...
    /**
     * Choose a MediaType based on the client's Accept request header.
     * @param request
     * @return
     */
    public static MediaType selectResponseType(Request request, Set<MediaType> supportedTypes, MediaType defaultType) {
