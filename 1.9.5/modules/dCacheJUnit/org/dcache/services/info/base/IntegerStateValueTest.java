...
public class IntegerStateValueTest extends InfoBaseTestHelper {
	...
	public void testAcceptVisitorStatePathStateVisitor() {
		...
		class TestIntegerVisitor implements StateVisitor {
			...
			StatePath foundPath;
			public void visitString( StatePath path, StringStateValue value) {broken = true;}
			public void visitInteger( StatePath path, IntegerStateValue value)  {foundPath = path; foundValue = value.getValue();}
			public void visitBoolean( StatePath path, BooleanStateValue value) {broken = true;}
			public void visitFloatingPoint( StatePath path, FloatingPointStateValue value) {broken = true;}
			public void visitCompositePreDescend( StatePath path, Map<String,String> metadata) {broken = true;}
			public void visitCompositePreLastDescend( StatePath path, Map<String,String> metadata) {broken = true;}
			public void visitCompositePostDescend( StatePath path, Map<String,String> metadata) {broken = true;}
			public void visitCompositePreSkipDescend( StatePath path, Map<String,String> metadata) {broken = true;}
			public void visitCompositePostSkipDescend( StatePath path, Map<String,String> metadata) {broken = true;}
		}
