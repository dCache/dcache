...
<html>
  ...
  <body>
    <h1>dCache Plots</h1>
    <h4>Standard View. <a href="/dcache/explots">Expert View.</a></h4>
    <%
	...
	<%
	    ...
	    for (int i = 0; i < flist.length; i++) {
	        ...
	        if (preName.indexOf(".week.") > 0)    // Skip all week plots
			    continue;
	        if (preName.indexOf(".cst.") > 0)    // Skip all cost plots
			    continue;
	        if (preName.indexOf(".tim.") > 0)    // Skip all connection time plots
			    continue;
	...
	<tr>
	  ...
	  <td>
	    <a href="/dcache/outplot?lvl=0&filename=<%= pngName %>">
	  ...
	  <td>
	    <a href="/dcache/outplot?lvl=0&filename=<%= dpngName %>">
	  ...
	  <td>&nbsp;&nbsp;&nbsp;Current week</td>
	  <td>
	    <a href="/dcache/outplot?lvl=0&filename=<%= wpngName %>">
...
<!-- hhmts start -->
Last modified: Thu Sep 11 18:00:16 CDT 2003
<!-- hhmts end -->
  </body>
</html>
